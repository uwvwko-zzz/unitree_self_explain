...
# TaskRegistry 是 legged_gym 的“任务中心枢纽”，它通过注册机制将环境类、环境配置、训练配置绑定到一个名字上，并提供统一接口来创建环境和训练器，
# 极大简化了实验流程，支持快速切换任务、复现实验、断点续训和参数覆盖
class TaskRegistry():
    def __init__(self):
        self.task_classes = {}      # 注册的任务类
        self.env_cfgs = {}          # 环境配置
    ...
    def get_cfgs(self, name): 
        ...
        # copy seed
        env_cfg.seed = train_cfg.seed   # 同步seed
